                  	...
                  	<div class="row mtbox">
                  		...
                  		<!--<div class="col-md-2 col-sm-2 box0">
                  			<div class="box1">
					  			...
					  			<p>El rendimiento del servidor es optimo.</p>
                  		</div>-->
                  ...
                  <div class="col-lg-3 ds">
                    <!--COMPLETED ACTIONS DONUTS CHART-->
                      ...
                      <div class="desc">
                      	...
                      	<div class="details">
                      		<p><muted>Usuario conectado</muted><br/>
                      		   <a href="#">En un futuro se va trabajar con sockets para mostrar notificaciones.<br/>
                      		</p>
                      	</div>
                      </div>
